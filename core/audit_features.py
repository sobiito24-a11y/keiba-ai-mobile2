...
AUDIT_EXPORT_COLUMNS = [
    ...
    "star_index_value",
    "star_index_rank",
    "away_same_distance_index_value",
    "away_same_distance_index_rank",
    "jra_condition_support_shadow",
    "jra_condition_support_count",
    "jra_condition_support_label",
    "jra_condition_attention",
    "jra_condition_support_reason",
    "nar_condition_distance_top3",
    "nar_condition_course_top3",
    "nar_condition_star_top3",
    "nar_condition_away_top3",
    "nar_condition_support_count",
    "nar_condition_attention",
    "nar_condition_support_reason",
    "jra_top5_score",
    "jra_top5_rank",
